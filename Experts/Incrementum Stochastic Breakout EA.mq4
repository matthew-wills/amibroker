...
string systemName = "Incrementum_Stochastic_Breakout";
...
extern int stochPeriod = 14;// Stochastic length

extern double stochEntryLong = 70;// Stochastic entry long
extern double stochEntryShort = 30;// Stochastic entry short
...
void Load_Indicator_Variables(){
   ...
   stoch1 = iStochastic(_Symbol,timeFrame,stochPeriod,3,3,MODE_EMA,0,MODE_MAIN,1);
   stoch2 = iStochastic(_Symbol,timeFrame,stochPeriod,3,3,MODE_EMA,0,MODE_MAIN,2);
}
...
void OpenNewTrades(){
   ...
   if(stoch1 > stochEntryLong && stoch2 < stochEntryLong){
   ...
   if(stoch1 < stochEntryShort && stoch2 >stochEntryShort){
...
void GenerateComments(){   
   ...
   com+="\n-Stochastic("+(string)stochPeriod+") = " + DoubleToString(stoch1,2);
   if(numOpenExpert!=0){
      com+="\n\n====================";
      com+="\n Open Position Info ";
      com+="\n====================\n"; 
