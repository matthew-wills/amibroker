...
//stopLoss_Gann
extern bool stopLoss_Gann_OnOff = true;           // StopLoss_GANN (on/off)
extern int stopLoss_Gann_Candles = 1;              //StopLoss_GANN NumCandles

int maxSlippage = 3000;// Max Acceptable Slippage 
...
void GenerateComments(){   
   ...
   com+="\n    INDICATOR VARIABLES";
   com+="\n=========================";   
   com+="\n-GT3_Indicator_1 = " + (string) GT3_Fast_1;
   com+="\n-GT3_Indicator_2 = " + (string) GT3_Fast_2;  
   ...
   if(numOpenExpert != 0){
      ...
      com+="\n    STOP VARIABLES";
      com+="\n=========================";  
      if(stopLoss_Gann_OnOff != 0)          com+="\n-SL_GANN_Price = " + DoubleToString(SL_Gann_Price,_Digits);
   }
