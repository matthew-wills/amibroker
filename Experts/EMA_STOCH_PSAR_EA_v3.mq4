...
void EnterLongPosition(){
   EnterPosition(_Symbol,OP_BUY,fixedLotSize,Ask,maxSlippage,Ask - stopLoss*_Point, Ask + takeProfit*_Point,magicNumber,"SEP");
}

void EnterShortPosition(){
   EnterPosition(_Symbol,OP_SELL,fixedLotSize,Bid,maxSlippage,Bid + stopLoss*_Point, Bid - takeProfit*_Point, magicNumber,"SEP");
}
