...
extern double accountPercent = 0.33;   //Ratio of Account Allocated
...
input int optimizingPeriods = 750; // Optimization periods(bars)
...
void Status()
{
   ...
   (          
       ...
       newLine, "tradesPerYear = ", DoubleToString( tradesPerYear, 2 ),
...
//////////////////////////Create File to check results//////////////////////////////////////////////
      ...
      string fileName = StringConcatenate(AccountCompany()," - ",AccountNumber(),"\\",expertName," - ",magicNumber," - ",Symbol(),"\\backtestData.csv");
