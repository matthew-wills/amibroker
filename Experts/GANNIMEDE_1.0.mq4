...
// Flags
bool flag_NewTrend = true;
int flag_NewTradeAllowed = 1;
...
void Load_Indicator_Variables(){
   GT3_Slow_1 = iCustom(_Symbol,PERIOD_CURRENT,"GANNIMEDE_IND1",GT3_Slow_TimeFrame,GT3_Slow_HighLowPeriod,GT3_Slow_ClosePeriod,GT3_Slow_Hot,2,1);
   GT3_Slow_2 = iCustom(_Symbol,PERIOD_CURRENT,"GANNIMEDE_IND1",GT3_Slow_TimeFrame,GT3_Slow_HighLowPeriod,GT3_Slow_ClosePeriod,GT3_Slow_Hot,2,2);   
   GT3_Fast_1 = iCustom(_Symbol,PERIOD_CURRENT,"GANNIMEDE_IND1",GT3_Fast_TimeFrame,GT3_Fast_HighLowPeriod,GT3_Fast_ClosePeriod,GT3_Fast_Hot,2,1);
   GT3_Fast_2 = iCustom(_Symbol,PERIOD_CURRENT,"GANNIMEDE_IND1",GT3_Fast_TimeFrame,GT3_Fast_HighLowPeriod,GT3_Fast_ClosePeriod,GT3_Fast_Hot,2,2);
...
int Signal(){  
   if(!useTrendFilter){ // not using trend filter
      if(GT3_Fast_1 == 1 && GT3_Fast_2 == -1){ // buy signal
         return(1);
      }
      if(GT3_Fast_1 == -1 && GT3_Fast_2 == 1){ // sell signal
         return(-1);
      }      
   }
